  ...
  return (
    <div className={classes.root}>
      <GridList cellHeight={350}
        ...
        <ListSubheader cols={2} style={{ fontFamily: "Jura", fontSize: "1.6em", fontWeight: "bold", color: "white", height: "auto", padding: "10px"}} component="div" >{tileData.length}&nbsp;{props.boozeType.charAt(0).toUpperCase() + props.boozeType.slice(1)}&nbsp;Drinks. &nbsp;Click picture to get recipe.
        </ListSubheader>
