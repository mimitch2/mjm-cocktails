...
const Info = () => {
  return (
    <div className="info-main" style={style.main}>
      ...
      <div style={style.heading}>
        <h2 style={style.heading}>API data scraped from <a href="https://www.thecocktaildb.com/api.php" target="_blank" rel="noopener noreferrer">The Cocktail DB</a> and self hosted on <a href="https://mlab.com" target="_blank" rel="noopener noreferrer">mLab.</a></h2>
